...
- `docs/skills/manage-project-docs/STATE.md`: continuation, current candidate,
  writer/delivery boundaries and outstanding decisions.
- `docs/skills/manage-project-docs/DESIGN.md`: changes to selection, workflow,
...
- `docs/skills/manage-project-docs/VERIFICATION.md`: checks affected by the change
  and the scope of existing evidence.

## Scope and ownership

- Treat `skills/manage-project-docs/` as the only editable installable Skill source.
...
- Select affected SOURCE, metadata or focused checks from
  `docs/skills/manage-project-docs/VERIFICATION.md`. Complete authorized local
