...
`docs/skills/manage-project-docs/DESIGN.md`, `docs/skills/manage-project-docs/STATE.md`, and
...
- Run any focused checker named in `docs/skills/manage-project-docs/VERIFICATION.md`.
