...
- **P:** the future B2 public `v0.3.0` Release commit. P remains `UNKNOWN` until B2; neither C nor R is P.

`PUBLIC_RELEASE`, `STABLE_INSTALLED_COPY`, and broad `EFFICACY_BOUNDARY` remain `UNKNOWN` until their own future evidence exists.
